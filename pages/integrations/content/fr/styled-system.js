module.exports = {
  ...
  subtitle: '',
  description: `
    ~glamorous~ fonctionne avec les fonctions d'aide de ~styled-system~.

    ~~~interactive {summary: 'Démo interactive', clickToRender: true}
    // En supposant import * as styledSystem from 'styled-system'
    // normalement vous devez juste faire import { space, width, fontSize } from 'styled-system'
